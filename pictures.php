...
<div class="page-wrapper">
    ...
    <li >
     ...
     <input type="text" name="search" class="form-control" placeholder="অনুসন্ধান করুন (বিষয় লিখুন)...">
	 </form>
     </div><!-- /.header-search -->
    ...
    <div class="hero-image-inner" style="background-image: url('assetsp/img/tmp/a1.jpg');">
		...
		<?php
			...
			$sql_query = "select topics,tag,source from picturetool where category like '$cat' and age like '$age' group by topics;";
...
<!--1st section-->
 ...
 <div class="container" >   
    ...
    <h1 style="color: #8a0ea3; font-weight:bold;">পিকচারগুলো </h1>
    <p style="font-size: 29px; color: black;">বয়সঃ ১-৫</p> 
...
<!--2nd Section-->   
 ...
 <div class="container">"   
    ...
    <div class="page-header">
    <h1 style="color: #8a0ea3; font-weight:bold;">পিকচারগুলো </h1>
    <p style="font-size: 29px; color: black;">বয়সঃ ৬-১৫ </p> 
</div><!-- /.page-header -->
       ...
       <?php
			...
			while( $i>0) 
			 ...
			 {  
               ...
               <div class="card-simple-label">Flower</div>
