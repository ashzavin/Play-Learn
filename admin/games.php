            ...
            <div id="page-inner">
			 <div class="row">
                    <div class="col-md-12">
                        ...
                        গেমস<small>    গেমস  সংক্রান্ত যাবতীয় তথ্য</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
					...
					<center>
                        ...
                        <div class="panel-heading">
						 ...
						 <h4> গেমস অ্যাড করুন</h4>
<div class="form-class">									
  <form action="addg.php">
    <label style="padding-left:30px;" for="fname">Title: </label>
    <input type="text" id="fname" placeholder="বিষয় লিখুন" name="name"><br>
	
	 <label style="padding-left:-100px;" for="fname">Instructions: </label>
    <input type="text" id="fname" placeholder="নিয়ম লিখুন" name="ins"><br>
	
	 
	
    <input value="image" style="padding-left:120px;" type="file" id="fname" name="source"><br>
	
    <br><input type="submit" value=" গেমস অ্যাড করুন ">
  </form></div>
    ...
    <?php
		...
		$result = mysqli_query($con,$query);
			...
			?>
					...
					<br>
                     <div class="box">
						<a href="#popup3" class="btn btn-fail"> গেমস মুছে ফেলুন </a>
					</div>
                      </center>
