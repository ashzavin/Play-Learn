        ...
        <header class="header-area inner-page">
            ...
            <nav id="po" class="navigation">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <ul class="main-menu pull-right">
                                ...
                                <li>
                                    <a id="a" style="color: #E60F65; font-weight:bold;" href="drawing.php">ড্রয়িং টুলস </a>
                                </li>
                ...
                <div class="search-area">
                    <form action="checkdraw.php" method="post">
...
<body>
    ...
    <div class="container">
        ...
        <!-- /.row -->
            ...
            <div class="col-md-6">
                <a href='.$source.'>
                    <img class="img-responsive" src='.$pic.' alt="" style="width: 400px; height:300px;">
                </a>
            </div> 
            <div class="col-md-6"></br></br></br>
                ...
                <a class="btn btn-primary" href='.$source.'>রং করো <span></span></a>
            </div>
        </div></br></br></br></br>';
				 }
